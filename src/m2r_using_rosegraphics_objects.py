...
#              The (0, 0) point is in the upper left of the screen.
#
#        -- In what direction on the screen
#           does the positive X-axis point?
#              The positive X-axis is in the right direction.
#
#        -- In what direction on the screen
...
#                Arc and Ellipse are two different Rose Graphics Objects
#
#          -- Write the names of three METHODs that Circle objects have:
#                center, outline_color, and outline_thickness
#
#          -- Write the names of three INSTANCE VARIABLEs that Circle
#             objects have:
#                center, radius and fill_color are all instance variables that Circles can have
#
#     f. What does a RoseWindow RENDER method do?
#            A window will draw all the objects that are attached to the window.
#
#     g. When is a RoseWindow close_on_mouse_click method call
#        necessary?  Why?
#            A close_on_mouse_click method is useful if you want to be able to see what you have drawn on the window before moving onto the next topic. It is also useful for debugging the program.
#
